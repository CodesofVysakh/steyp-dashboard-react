        ...
        <Content>
            ...
            <Block>
                <Form>
                    ...
                    <Input type="number" placeholder="Enter OTP" required onKeyDown={e => symbolsArr.includes(e.key) && e.preventDefault()} required />
                    {/* {counter ? <Link to="/passwordreset">
                        <ColorSpan onClick={resetCounter}>Resend OTP</ColorSpan>
                    </Link>: */}
                    <Span onClick={resetCounter} counter={counter}>Resend OTP <Wrap counter={counter}>in {counter}</Wrap></Span>
                    <Link to="/passwordvalidation">
